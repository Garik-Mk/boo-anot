...
class Ui_ImageViewer(object):
    def setupUi(self, ImageViewer):
        ...
        self.item_list.setAutoScrollMargin(1)
        ...
        self.actionAdd_number_to_each_filename_end = QtWidgets.QAction(ImageViewer)
        self.actionAdd_number_to_each_filename_end.setObjectName("actionAdd_number_to_each_filename_end")
        ...
        self.actionAdd_Label_To_Filename = QtWidgets.QAction(ImageViewer)
    ...
    def retranslateUi(self, ImageViewer):
        ...
        self.label.setText(_translate("ImageViewer", "Clear Noise - 0, Human -1, Car - 2, Noise w/h line -3, Noisy Noise - 4  "))
        ...
        self.actionSame_Data_and_Label_Folder.setText(_translate("ImageViewer", "Don\'t rename files"))
        self.actionMove_images_to_labels.setText(_translate("ImageViewer", "Move Images To Labels"))
        self.actionAdd_number_to_each_filename_end.setText(_translate("ImageViewer", "Add Number To Each Filename"))
