...
class Ui_processor(object):
    def setupUi(self, processor):
        ...
        self.imageFrame = QtWidgets.QHBoxLayout()
        self.imageFrame.setObjectName("imageFrame")
        self.verticalLayout.addLayout(self.imageFrame)
        ...
        self.images_per_frame_spin_box.setMaximum(10)
    ...
    def retranslateUi(self, processor):
        ...
        self.groupBox.setTitle(_translate("processor", "Current Images"))
