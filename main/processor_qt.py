...
class Ui_processor(object):
    def setupUi(self, processor):
        ...
        self.SaveAllVideoData = QtWidgets.QPushButton(self.toolMenu)
        self.SaveAllVideoData.setObjectName("SaveAllVideoData")
        self.verticalLayout_3.addWidget(self.SaveAllVideoData)
        ...
        self.SaveVideoData = QtWidgets.QCheckBox(self.toolMenu)
        self.SaveVideoData.setEnabled(False)
        self.SaveVideoData.setObjectName("SaveVideoData")
        self.verticalLayout_3.addWidget(self.SaveVideoData)
    ...
    def retranslateUi(self, processor):
        ...
        self.fill_mode_box.setItemText(2, _translate("processor", "Extracted Noise"))
        self.fill_mode_box.setItemText(3, _translate("processor", "Auto (Quilt)"))
        self.fill_mode_box.setItemText(4, _translate("processor", "Auto (Shuffle)"))
        ...
        self.SaveAllVideoData.setText(_translate("processor", "Save All Video Data"))
        ...
        self.SaveVideoData.setText(_translate("processor", "Save Video Data"))
