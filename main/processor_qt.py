...
class Ui_processor(object):
    def setupUi(self, processor):
        ...
        self.filler_image = QtWidgets.QLineEdit(self.groupBox_2)
        self.filler_image.setReadOnly(True)
    ...
    def retranslateUi(self, processor):
        ...
        self.filler_image.setPlaceholderText(_translate("processor", "Current Filler Image"))
