...
class Ui_processor(object):
    def setupUi(self, processor):
        ...
        self.images_per_frame_spin_box.setProperty("value", 5)
        ...
        self.currentX = QtWidgets.QSpinBox(self.groupBox_4)
        self.currentX.setMinimum(-99)
        self.currentX.setObjectName("currentX")
        self.gridLayout.addWidget(self.currentX, 0, 1, 1, 1)
        self.currentY = QtWidgets.QSpinBox(self.groupBox_4)
        self.currentY.setMinimum(-99)
